...
type FaqCat = "general" | "web" | "marketing" | "content" | "pricing" | "support";

// ── FAQ DATA ────────────────────────────────────────────────
const FAQ: Record<FaqCat, { title: string; items: { q: string; a: string }[] }> = {
  general: {
    title: "🏢 General FAQs",
    items: [
...
const FAQ_CATEGORIES: { cat: FaqCat; icon: string; title: string; sub: string }[] = [
